...
1. AGENTS.md — project-specific rules and scope
2. DECISIONS.md — why things are built the way they are
3. PLAN.md — current milestone, ordered task list, what's done vs remaining
4. tasks/lessons.md — mistakes made and patterns learned across sessions
...
| Tool | Role | Permission model |
|---|---|---|
| **Claude.ai chat** | Planning, architecture, prompt design, workflow decisions | N/A — advisory only |
| **Claude Code** | Code execution, file edits, git operations | EDIT_OK required per session |
| **Codex** | Autonomous scoped tasks (docs, migrations, refactors) | Scope defined in the prompt itself |
...
1. Gate command passes (see Quality Gates)
2. Diff-smell checklist passes (see docs/diff-smell-checklist.md)
